...
describe('HTTP routes', () => {
  it('serves API token endpoint', async () => {
    ...
    // configModel is present when ~/.copilot/config.json exists (may be
    // undefined in CI where no copilot config is installed)
    expect(body).toHaveProperty('configModel');
  });
